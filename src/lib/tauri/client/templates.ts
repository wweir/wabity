...
export const browserBuiltinLlmProviderTemplates: BuiltinLlmProviderTemplate[] = [
	...
	},
	{
		...
		registrationLabel: "开通 / 控制台",
		registrationUrl: "https://bailian.console.aliyun.com/",
		apiKeyLabel: "API Key 说明",
		apiKeyUrl: "https://help.aliyun.com/zh/model-studio/get-api-key",
		docsLabel: "OpenAI 兼容文档",
	...
	},
	{
		...
		registrationLabel: "开通 / 控制台",
		registrationUrl: "https://www.volcengine.com/docs/82379/1330626",
		apiKeyLabel: "API Key 说明",
		apiKeyUrl: "https://www.volcengine.com/docs/82379/1399008",
		docsLabel: "OpenAI SDK 文档",
	...
	},
	{
		...
		registrationLabel: "开通 / 控制台",
		registrationUrl: "https://hunyuan.tencent.com/",
		apiKeyLabel: "API Key 说明",
		...
		models: [
			{
				...
				supportsStateful: false,
				recommendedFor: ["translation", "rag_answer"],
				summary: "通用文本模型，适合日常问答、改写和低延迟生成。",
				selectableInCurrentApp: true,
				disabledReason: null,
			},
			{
			...
			},
			{
				...
				supportsStateful: false,
				recommendedFor: ["embedding"],
				summary: "官方 Embedding 模型，适合给 RAG 建立文本向量索引。",
				selectableInCurrentApp: true,
				disabledReason: null,
			},
		],
